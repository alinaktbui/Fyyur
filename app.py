...
# TODO Implement Show and Artist models, and complete all model relationships and properties, as a database migration. 
        # Lesson 7: Build a CRUD App with SQLAlchemy ORM - Part 2 - Many-To-Many Relationships: Part I & II Video 
...
def search_venues():
  # TODO: implement search on artists with partial string search. Ensure it is case-insensitive.
        #Lesson 4: SQLAlchemy ORM in Depth - Model.query
  ...
  response={
    "count": results_count,
    "data": [b.serialize for b in books]
  }
